 ...
 * @str: string
 * @num: number of nodes used by history
...
/**
 * print_list_str - prints the string of the linked list.
...
/**
 * free_list - frees all the nodes list
 * @head_ptr: pointer to head node's address
 * Return: void
 */
